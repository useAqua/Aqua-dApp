...
const Footer = () => {
  return (
    <footer className="relative mt-8 overflow-x-clip pb-4">
        ...
        <div className="flex items-center justify-center">
          {[1, 2, 3].map((i) => (
            <span
              key={i}
              className={cn(
                "font-redaction text-[16.6666667vw] italic lg:text-[180px]",
                i === 2
                  ? "z-1 -mx-[3%]"
      ...
      <div className="border-border border-t px-4 pt-4 pb-6">
        <div
          className={
