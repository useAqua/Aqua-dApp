...
const strategy_abi = [
    ...
    inputs: [
      {
        indexed: false,
        internalType: "address",
        name: "aquaFeeRecipient",
        type: "address",
      },
    ],
    name: "SetAquaFeeRecipient",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "aquaFeeConfig",
    outputs: [
      { internalType: "contract IFeeConfig", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
        ...
        components: [
          {
            components: [
              ...
              { internalType: "uint256", name: "Aqua", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_pointsPool", type: "address" },
      {
        components: [
          ...
          { internalType: "address", name: "aquaFeeConfig", type: "address" },
        ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_aquaFeeConfig", type: "address" },
    ],
    name: "setAquaFeeConfig",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_aquaFeeRecipient", type: "address" },
    ],
    name: "setAquaFeeRecipient",
    outputs: [],
    stateMutability: "nonpayable",
